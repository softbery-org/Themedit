...
namespace SfbLibrary.Components
{
    ...
    */
    ...
    public partial class ColorSliderBar : Control
    {
        #region Events
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ColorSliderBar"/> class.
        /// </summary>
        /// <param name="min">The minimum value.</param>
        /// <param name="max">The maximum value.</param>
        /// <param name="value">The current value.</param>
        public ColorSliderBar(decimal min, decimal max, decimal value)
        {
            InitializeComponent();
        ...
        /// Initializes a new instance of the <see cref="ColorSliderBar"/> class.
        /// </summary>
        public ColorSliderBar() : this(0, 100, 30) { }
